      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex h-48 w-full">
            <div
              className={`relative ${
                secondImageSrc ? "w-1/2" : "w-full"
              } h-full bg-gray-900 cursor-pointer group transition-all duration-300`}
          ...
          <h3 className="px-4 pt-3 pb-2 text-xl font-bold text-white">
            {title}
          </h3>
        </div>
        ...
        <div className="p-6">
          <div className="space-y-3">
            {items.map((item, index) => (
              <div
                key={index}
                className="flex justify-between items-center border-b border-gray-700/50 pb-2"
              >
