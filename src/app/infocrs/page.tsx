        ...
        <div className="flex">
          ...
          <main className="flex-1 p-6 lg:p-8">
            <motion.div 
              ...
              className="mb-8"
            >
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 flex items-center">Présentation de la Compagnie Républicaine de Sécurité <img src="/crslogo.svg" alt="Logo CRS" className="h-10 w-auto" /></h2>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              >
                <p className="mb-3">La Compagnie Républicaine de Sécurité plus connue sous le nom de CRS à été crée par un décret du 8 décembre 1944 suite à la dissolution des Groupes Mobiles de Réserves.</p>
              </InfoCard>
              ...
              >
                ...
                <ul>
                    <li>● Assurer le maintien de l’ordre public et son rétablissement si nécessaire ;</li>
                    <li>● assurer les missions propres de surveillance et de protection des personnes et des biens ;</li>
                    <li>● concourir, avec les effectifs de la direction centrale de sécurité publique, à la lutte contre les violences urbaines ;</li>
                    <li>● participer à la lutte contre le terrorisme et intervenir sur des actions de tuerie de masse et autres actes terroristes ;</li>
                    <li>● porter aide et assistance aux populations en cas de sinistres graves ;</li>
                    <li>● sécurité routière et surveillance des autoroutes (autoroutes de contournement des grandes agglomérations) ;</li>
              ...
              >
                <p>Dans cette partie vous retrouverais les différents services de la CRS.</p>
                <ul>
                    <li>● Brigade Motorisé Urbaine (Tango Mike)</li>
                    <li>● Le secours en Montagne.</li>
                    <li>● Le Maintien de l'Ordre (MO) qui inclus l'unité d'élite de la CRS ← CRS 8.</li>
