...
export default function SignInClient() {
  ...
  if (error === "Signin") {
    ...
    errorMessage =
      "❌ Vous n'êtes pas autorisé à accéder à ce site. Vérifiez que vous êtes membre du serveur Discord et que vous avez le bon rôle.";
    ...
    errorMessage =
      "❌ Erreur d'authentification. Vous devez être membre du serveur Discord avec le bon rôle.";
      ...
      <div className="relative z-10 text-center max-w-md mx-auto p-8">
        <div className="bg-gray-900/80 backdrop-blur-sm rounded-lg border border-gray-700 p-8 shadow-2xl">
          ...
          <p className="text-gray-300 mb-8 text-sm">
            ...
            l&apos;intranet Police Judiciaire de France RP. Vous devez être
            membre du serveur Discord avec le rôle approprié.
          </p>
            ...
            <div className="space-y-4">
              {Object.values(providers).map((provider: any) => (
                <div key={provider.name}>
                  <button
                    onClick={() =>
                      signIn(provider.id, { callbackUrl: "/accueil" })
                    }
          ...
          <div className="mt-6 pt-6 border-t border-gray-700">
            <p className="text-xs text-gray-400">
              En vous connectant, vous acceptez d&apos;être membre du serveur
              Discord de la Police Judiciaire du serveur France RP.
            </p>
          </div>
        </div>
      </div>
