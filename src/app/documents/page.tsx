...
import { FaFile, FaFileAlt, FaFileInvoiceDollar, FaShip } from 'react-icons/fa';
        ...
        <div className="flex">
          ...
          <main className="flex-1 p-6 lg:p-8">
            <motion.div 
              ...
              className="mb-8"
            >
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 flex items-center">Accès au différents documents de la CRS <img src="/crslogo.svg" alt="Logo CRS" className="h-10 w-auto" /></h2>
            </motion.div>
              ...
              >
                <p>Consultez cette page pour avoir le tableau des différents amendes à mettre en fonction de leurs gravités avec leurs numéros de classements, les prixs, les points à retiré.</p>
                <button onClick={() => router.push('/documents/amendescrs')} className="text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
                   → Voir le document
                </button>
              </InfoCard>
              ...
              >
                <p>Voici le document officielle de la formation BMU de la CRS.</p>
                <button onClick={() => router.push('/documents/formationbmu')} className="text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
                  → Voir la formation
                </button>
              </InfoCard>
              ...
              >
                <p>Voici le document officielle de la formation ERI de la CRS.</p>
                <button onClick={() => router.push('/documents/formationeri')} className="mt-3 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
                  Voir la formation →
                </button>
              </InfoCard>
              ...
              >
                <p>Voici le document officielle de la formation Maritime de la CRS.</p>
                <button onClick={() => router.push('/documents/formationmaritime')} className="mt-3 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
                  Voir la formation →
                </button>
              </InfoCard>
              ...
              >
                <p>Voici le document officielle de la formation Maintien de l'Ordre de la CRS (document temporaire).</p>
                <button onClick={() => router.push('/documents/formationmo')} className="mt-3 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
                  Voir la formation →
                </button>
              </InfoCard>
              ...
              >
                <p>Voici le document officielle des sous spécialités de la CRS.</p>
                <button onClick={() => router.push('/documents/sous-spe-crs')} className="mt-3 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
